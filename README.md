...
A small exploratory data analysis project using the "Cost of Living Index 2022" dataset. The main notebook `analysis.ipynb` (Colab-compatible) performs data loading, basic cleaning, and visualization of cost-of-living metrics by country and region. This repository stores the notebook and the dataset used for the analysis.
...
- The included image `images/analysis_dashboard.png` is a static screenshot of the produced visualizations — place the image in that path so the README displays it.
